...
print(data[data['v1'] == 'Positive'].size)
print(data[data['v1'] == 'Negative'].size)
...
text = np.array(['A lot of good things are happening. We are respected again throughout the world, and thats a great thing'])
print(text.shape)
